...
describe "UserPages" do
  ...
  describe "profile page" do
    ...
    describe "follow/unfollow buttons" do
      ...
      describe "following a user" do
        ...
        it "should increment 'following' user's followed user count" do
          expect do
            click_button "Follow"
          end.to change(user.followed_users, :count).by(1)
        end
        
        it "should increment the 'followed' user's follower count" do
          expect do
            click_button "Follow"
      ...
      describe "unfollowing a user" do
        ...
        it "should decrement 'following' user's followed user count" do
          expect { click_button "Unfollow" }.to change(user.followed_users, :count).by(-1)
        end

        it "should decrement 'followed' user's follower count" do
  ...
  describe "user follow/following pages" do
    let(:user) { FactoryGirl.create(:user) }
    let(:other_user) { FactoryGirl.create(:user) }
